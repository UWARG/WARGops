            ...
            <div class="w-[70vw]">
                ...
                <v-dialog v-model="dialog" width="800">
                    <template v-slot:activator="{ props }">
                        <v-btn v-bind="props" color="primary" size="large" variant="tonal" class="my-4">
                            Create New Account
                        </v-btn>
                    </template>
                            ...
                            <div class="flex py-4">
                                <div class="mr-4 flex-1 flex">
                                    <div class="flex flex-col mr-2">
                                        <p><span class="font-bold">Point of Contact:</span> {{
                                            account.point_of_contact
                                        }}</p>
                                        <p><span class="font-bold">Account Id:</span> {{ account.id }}</p>
                                        <p><span class="font-bold">Account Creator:</span> {{ account.creator }}</p>
                                        <p><span class="font-bold">Created On: </span>{{ account.allocation_date }}</p>
                                    </div>
                                    <div class="flex flex-col ml-2">
                                        <p><span class="font-bold">Allocated Funds: </span> Lorem</p>
                                        <p><span class="font-bold">Account Balance:</span> Lorem</p>
                                        <p><span class="font-bold">Pending Balance:</span> Lorem</p>
                                        <p><span class="font-bold">Total Transactions: </span>Lorem </p>
                                    </div>
                                </div>
